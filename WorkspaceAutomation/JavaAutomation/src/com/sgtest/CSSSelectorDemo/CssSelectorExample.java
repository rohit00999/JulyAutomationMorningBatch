package com.sgtest.CSSSelectorDemo;
...
public class CssSelectorExample {
	...
	static void navigate()
	{
		try
		{
			oBrowser.get("E:\\SG Testing Notes\\Java Notes\\CSS_Selector_13th_Sept_2021\\Sample.html");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	/**
	 * case 6
	 * Identify based on the <tagname> with attribute name and value combination
